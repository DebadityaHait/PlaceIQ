...
export default async function RecruiterJobsPage() {
  ...
  return (
    <main className="container grid gap-6 py-8">
      <div className="flex items-center justify-between"><h1 className="text-3xl font-bold">Your jobs</h1><Link className="btn" href="/recruiter/jobs/new">Post job</Link></div>
